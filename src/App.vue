      ...
      <template v-slot:hdrExtend>
        <div style="position: relative;">
          <transition name="fade" mode="in-out">
            <div v-show="showTooltip" class="tooltip" @click="showTooltip = false">Для начала работы выберите офис &#8681;</div>
          </transition>
          <el-select
            :disabled="showModal"
            v-model="office"
        ...
        <button class="btn_textstyle editrecord ml-auto" @click="downloadModal.visible = true" style="margin-right: 10px;">
          Скачать анкеты
        </button>
      ...
      <template v-if="activeOffice" v-slot:cellContent="slotProps">
        ...
        <div class="calendar_btn_wrap">
          ...
          >
            ...
            ><i></i>{{ recordCountByDay[slotProps.day + '_' + slotProps.hour + ':' + minute + ':00'] }}</span>
        ...
        <div class="input_wrap">
          ...
          <div class="input_50 mb_20 input_wrap" style="padding-top: 0;">
            ...
            <div class="input_50">
              ...
              <el-select v-model="slotData.formData.interview_hours" style="width: 100%;" :disabled="!slotData.formData.interview_date">
                <el-option
                  v-for="item in hours"
                  :key="item"
                  :label="item"
            ...
            <div class="input_50">
              ...
              <el-select v-model="slotData.formData.interview_minutes" style="width: 100%;" :disabled="!slotData.formData.interview_date">
                <el-option
        ...
        <transition-group tag="div" name="fade" mode="out-in" class="transition_wrap">
          ...
          <div class="tab" v-if="createRecordModal.activeTab === 1" :key="1">
            ...
            <div class="input_wrap dashed spaced mt_20">
              ...
              <button class="slearfieldsBtn" @click="scope.formData.from.date=null;scope.formData.to.date=null">
                &#215;
              </button>
            </div>
          ...
          <div class="tab" v-if="createRecordModal.activeTab === 2" :key="2">
            ...
            <div class="input_wrap my_10">
              <el-checkbox v-model="scope.formData.allHours">Деактивировать выбранный адрес на все время</el-checkbox>
            </div>
            ...
            <transition name="fade">
              <div v-if="!scope.formData.allDay && !scope.formData.allHours" class="input_wrap dashed spaced mt_20">
                <div class="input_wrap">
    ...
    >
      <template v-slot:formExtend="scope">
        ...
        <div class="input_wrap dashed spaced mt_20">
          ...
          <button class="slearfieldsBtn" @click="scope.formData.from=null;scope.formData.to=null">
            &#215;
          </button>
        </div>
      </template>
...
//            todo validate
        if (this.createRecordModal.valid){ // if valid - submit
          // check type of form:
          if (this.createRecordModal.activeTab == 1){ // Активация
//            todo request
            console.log("Add record", $event)
          } else if (this.createRecordModal.activeTab === 2){ // Деактивация
//            todo request
            console.log("Delete record", $event)
          } else if (this.createRecordModal.activeTab === 3){ // Кол-во записей
//            todo request
            console.log("Set max record count", $event)
          } else {
            console.log(`%c data fail: this.createRecordModal.activeTab - no matched parameters. Check tab id's`, "background:red;color:#fff;")
            return
          }
        }
