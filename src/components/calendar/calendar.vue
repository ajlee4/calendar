  ...
  <div class="calendar_wrap">
    ...
    <div class="table_wrap">
      ...
      <div
        ...
        class="table_row"
      >
        <div class="table_cell titles">
          {{ hour }}
        </div>

        <div
          v-for="(day, idx) in currentWeek.daysKeys"
          :key="idx"
          class="table_cell"
        >
  ...
  export default {
    ...
    computed: {
      currentWeek() {
        ...
        var endOfWeek = this.$moment(this.selectDate).endOf('isoWeek').day(-2);
        ...
        while (day <= endOfWeek) {
          days.push(`${day.format("dd")}, ${day.format("DD")} ${day.format("MMM")}`);
